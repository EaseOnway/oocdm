...
from alg.model.mlp_model import MLPModel
...
class TrainMLP(Train):
    ...
    def __init__(self, env_id: str,
                 ...
                 env_options={},
                 _continue=False):
        super().__init__(env_id, title='mlp'+suffix, run_id=run_id, train_args=train_args,
            model_args=model_args, env_options=env_options, _continue=_continue)

        if model_args is None:
            model_args = self.ModelArgs()
        model = self.make_model(MLPModel, model_args)
